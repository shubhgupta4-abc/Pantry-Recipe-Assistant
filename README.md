...
1. Run the program.
2. Choose `1` and add a few ingredients (e.g., rice, onion, tomato).
3. Choose `4` and add a recipe that uses ingredients you have, plus one recipe that needs something you don't have.
4. Choose `6` to see the suggestions — the recipe you can fully make should show up as `[READY]`.
5. Choose `7`, type the name of the recipe you're missing ingredients for, and check that the shopping list only lists what's missing.
6. Choose `0` to save and exit, then run the program again — your pantry and recipes should still be there.
